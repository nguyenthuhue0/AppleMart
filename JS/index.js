...
let flashSaleProducts = [
  ...
  {
    name: `Apple iMac 2021 M1 24 – Chính hãng Apple Việt Nam`,
  ...
  {
    name: `Apple iMac 2021 M1 24 - Chính hãng VN/A`,
  ...
  {
    name: `AirPod Pro - Chính hãng VN/A`,
    currentPrice: "27,390,000 ₫",
    salePrice: "23,690,000 ₫",
...
function loadIphone() {
  ...
  iPhoneProducts.forEach((item, key) => {
    if (key >= beginGet && key <= endGet) {
      html += `<div class="card mx-2 border-0 p-0">
